...
| 模块 | 说明 |
| --- | --- |
| 赛程一览 | 按日期（昨天 / 今天 / 未来 5 天）与赛事分类筛选，覆盖 21 项赛事：五大联赛、英冠、葡超、荷甲、巴西甲、欧冠、解放者杯、欧洲杯、世界杯（football-data）及韩K、日职、沙特甲、瑞典超、丹麦超、荷兰乙、德国乙、墨西哥超（API-Football 补充） |
...
3. 重启服务。服务端会自动把 football-data 比赛与 API-Football 比赛按队名匹配，然后：
   ...
   - **补充赛事**：韩K、日职、沙特甲、瑞典超、丹麦超、荷兰乙、德国乙、墨西哥超 8 项联赛的赛程与比分由 API-Football 提供（football-data 免费档无这些赛事），赔率/事件按需拉取以节省配额。
