...
/* ---------- 赛事名词典 ---------- */
const COMP_DICT = {
  'bundesliga': '德甲', 'dfb pokal': '德国杯',
  'premier league': '英超', 'efl championship': '英冠', 'championship': '英冠',
  'fa cup': '足总杯', 'efl cup': '联赛杯', 'carabao cup': '联赛杯',
  'la liga': '西甲', 'copa del rey': '国王杯', 'supercopa de espana': '西班牙超级杯',
  'serie a': '意甲', 'coppa italia': '意大利杯', 'supercoppa': '意大利超级杯',
  'ligue 1': '法甲', 'ligue 2': '法乙', 'coupe de france': '法国杯',
  'champions league': '欧冠', 'uefa champions league': '欧冠',
  'europa league': '欧联杯', 'uefa europa league': '欧联杯',
  'conference league': '欧协联', 'europa conference league': '欧协联',
  'eredivisie': '荷甲', 'primeira liga': '葡超', 'super lig': '土超',
  'saudi pro league': '沙特联', 'mls': '美职联', 'a-league': '澳超',
  'copa libertadores': '南美解放者杯', 'copa sudamericana': '南美杯',
  'world cup': '世界杯', 'fifa club world cup': '世俱杯',
  'european championship': '欧洲杯', 'copa america': '美洲杯',
